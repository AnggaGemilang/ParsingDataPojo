        ...
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(ActivityMoveWithData.EXTRA_NAME,
                        "Angga Gemilang");
                moveWithDataIntent.putExtra(ActivityMoveWithData.EXTRA_AGE,
                        16);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setNama("Angga Gemilang");
                mPerson.setAge(16);
                mPerson.setEmail("angga.gemilang.mu@gmail.com");
                mPerson.setCity("London");
                Intent moveWithObjectIntent = new Intent(MainActivity.this,
                        ActivityMoveWithObject.class);
                moveWithObjectIntent.putExtra(ActivityMoveWithObject.EXTRA_PERSON, mPerson);
                startActivity(moveWithObjectIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "083195008217";
